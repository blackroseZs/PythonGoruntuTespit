...
videom = cv2.VideoCapture(0) #Pc kamerası
ret, frame1 = videom.read()  #Kameradan framelerin alınması
...
while True:
    ...
    if kontur1:
        ...
        cv2.putText(roi1, "DURUM: {}".format('HAREKET YOK'), (10, 10), cv2.FONT_HERSHEY_TRIPLEX,
                    0.5, (255, 0, 0), 1)
        print("cam1 Hareket Yok!")
        #E-posta gönderimi için
        #os.system('py eposta.py')
    ...
    if kontur:
        for a in kontur:
            ...
            cv2.putText(roi3, "DURUM: {}".format('HAREKET YOK'), (10, 10), cv2.FONT_HERSHEY_TRIPLEX,
                        0.5, (0, 0, 255), 1)
            print("cam2 Hareket Yok!")
            #os.system('py eposta2.py')
